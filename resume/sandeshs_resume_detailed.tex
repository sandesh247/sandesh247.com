...
\noindent We proposed an NLP approach to detecting vandalism, by modeling
edits and vandal edits using a probabilistic context free grammar, and
used the model to evaluate new edits. We attained 84\% precision and
89\% recall.
...
speaker, by building an ngram model over various features of an
