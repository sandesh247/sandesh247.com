...
\item [Languages]
\begin{itemize*}
  \item proficient in C\#, Javascript, C, C++
  \item working experience with Python, shell scripting, Ruby, Java
\end{itemize*}
...
\item [Data] 
\begin{itemize*}
  \item used and optimized MDX/DMX queries for data mining on Microsoft Analysis Services
  \item worked with Microsoft Sql Server for application and ORM development
