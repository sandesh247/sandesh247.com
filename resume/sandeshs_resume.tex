...
\item [Languages]
\begin{itemize*}
  \item proficient in Python, Bash, Javascript, C\#
  \item working experience with Ruby, Java, C, C++
\end{itemize*}
...
\item [Data] 
\begin{itemize*}
  \item classification and mining with Weka, numpy
  \item data mining on Microsoft Analysis Services with MDX/DMX, SQL, ORM development
\end{itemize*}
