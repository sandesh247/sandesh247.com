...
\begin{center}
  ...
  \centering{
    \makebox[0.3\linewidth][c]{\Mobilefone\quad+1 347-687-7748}
    \makebox[0.3\linewidth][c]{
      \Letter\quad
      \href{mailto:sandesh247@gmail.com}{me@sandesh247.com}
    }
    \makebox[0.3\linewidth][c]{
      \Keyboard\quad\url{http://sandesh247.com}
    }
  } \\
...
\begin{itemize*}
\item won many programming contests around the Mumbai University campus during engineering studies
\item received accolades and special bonuses while working in Amdocs DVCI
\item listen to Hans Zimmer, ColdPlay, Beatles, Dido; read P.G. Wodehouse, John Grisham; play cricket
\end{itemize*}
